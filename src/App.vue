...
<template>
    <div class="content">
        <header class="title">
            <div class="summary">
                <h1><RouterLink :to="'/'">IsmaTasks</RouterLink></h1>

                <p>
                    {{ doneTasks }} tareas pendientes de un total de
                    {{ totalTasks }}
                </p>
